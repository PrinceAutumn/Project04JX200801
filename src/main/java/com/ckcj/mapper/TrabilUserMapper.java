...
import com.ckcj.Tools.TestTraibilRoleMapper;
...
public interface TrabilUserMapper {
    ...
    public default <Tbluser, addTblUser> void loginUser(@Param(value = "un"）
            String @Uname, @Param(value = "up")String Upwd);
    int addTblUser=0;(TblUserdao.Tbluser TestTraibilRoleMapper.Tbluser
            class Tbluser;{
    };
